...
description: >-
  ...
  difference between a problem and a mechanism. Trigger when the user says things like "the problem we solve is",
  "our users need", "we help people", or presents a problem statement for review.
---
